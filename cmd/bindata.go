...
func templatesIndexHtml() (*asset, error) {
	path := "/home/stevek/src/nsre/templates/index.html"
...
// templatesLoad_log_formGoHtml reads file data from disk. It returns an error on failure.
func templatesLoad_log_formGoHtml() (*asset, error) {
	path := "/home/stevek/src/nsre/templates/load_log_form.go.html"
	name := "templates/load_log_form.go.html"
	bytes, err := bindataRead(path, name)
	if err != nil {
		return nil, err
	}
...
// templatesSearchpageGoHtml reads file data from disk. It returns an error on failure.
func templatesSearchpageGoHtml() (*asset, error) {
	path := "/home/stevek/src/nsre/templates/searchpage.go.html"
	name := "templates/searchpage.go.html"
	bytes, err := bindataRead(path, name)
	if err != nil {
		return nil, err
	}
